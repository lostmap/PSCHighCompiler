...
#if defined _DEBUG
	HINSTANCE hVMDLL = LoadLibrary(L"../../../../../VirtualMachine/x64/Debug/VirtualMachine.dll");
#else
	HINSTANCE hVMDLL = LoadLibrary(L"../../../../../VirtualMachine/x64/Release/VirtualMachine.dll");
#endif
